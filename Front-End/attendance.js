...
function initAttendancePage() {
  ...
  // Show course information from localStorage
  const lectureData = JSON.parse(localStorage.getItem('lectureData'));
  if (lectureData) {
    document.getElementById('courseInfo').textContent = 
      `${lectureData.course} - ${lectureData.type} (${lectureData.time}, ${lectureData.room})`;
  }
